        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-6 text-sm text-[var(--muted)]">
          ...
          <span className="inline-flex items-center gap-2">
            ...
            <a
              ...
              className="text-[var(--muted)]/80 hover:text-[var(--gold)] transition-colors duration-300"
              aria-label="Wen Yuan on LinkedIn"
            >
              <svg
            ...
            <a
              href="https://github.com/WenYuan77/David-s-Photography-Shop"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[var(--muted)]/80 hover:text-[var(--gold)] transition-colors duration-300"
